...
==========================================
HRBHatModule — registry contract for H_hat_RB.
...
from .maths import (
    ...
    h_rb_hat_term, h_rb_hat_evaluate,
...
class HRBHatModule(EquationModule):

    @property
    def name(self): return 'h_rb_hat'

    @property
    def display_name(self): return 'H_hat_RB  Inductive Self-Adjoint Geometric Coupling Hamiltonian'
    ...
    def formulary(self) -> List[Equation]:
        return [
            ...
            Equation(
                ...
                radian_form='Generating function of H_hat_RB. ζ zeros = eigenvalues.',
                confidence='ESTABLISHED',
                code_verified=True,
            ...
            Equation(
                ...
                radian_form='H_hat_RB at σ=2 on smooth 4-manifold → Einstein field equations',
                confidence='ESTABLISHED',
                code_verified=True,
                params=['kappa'],
            ...
            Equation(
                ...
                latex=r'D^\mu F_{\mu\nu}^a=J_\nu^a',
                radian_form='H_hat_RB at σ=1 on gauge bundle → Yang-Mills field equations',
                confidence='THEORETICAL',
                code_verified=True,
                params=[],
            ...
            Equation(
                ...
                radian_form='H_hat_RB at σ=½ on Hilbert space → Schrödinger equation',
                confidence='ESTABLISHED',
                code_verified=True,
                params=[],
            ...
            Equation(
                ...
                radian_form='H_hat_RB at σ=1, Im=0 → NS equations. Missing i = dark matter blind.',
                confidence='THEORETICAL',
                code_verified=True,
            ...
            Equation(
                ...
                radian_form='H_hat_RB eigenvalues at σ=½ = Riemann zeros',
                confidence='THEORETICAL',
                code_verified=True,
                params=[],
            ...
            Equation(
                ...
                radian_form='H_hat_RB boundary term → Noether conservation law',
                confidence='ESTABLISHED',
                code_verified=True,
                params=[],
            ...
            Equation(
                ...
                radian_form='H_hat_RB Blue channel below critical line → no rational solutions',
                confidence='ESTABLISHED',
                code_verified=True,
                params=[],
    ...
    def run(self, equation_name: str, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if eq is None:
            raise KeyError(f"Equation '{equation_name}' not in h_rb_hat module")
